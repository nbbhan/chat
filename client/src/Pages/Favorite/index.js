                    ...
                    <div className="favorite-main">
                        ...
                        <div className="favorite-main-container">
                            <div className="favorite-main-items">
                                <div className="favorite-main-item">
                                    <div className="favorite-main-item-container">
                                        ...
                                        <div className="favorite-main-item-inf">
                                            <div className="favorite-main-item-inf-container">
                                                <div className="favorite-main-item-name">商品名</div>
                                                <div className="favorite-main-item-price">100円（税込）</div>
                                                <div className="favorite-main-item-rating">5</div>
                                            </div>
